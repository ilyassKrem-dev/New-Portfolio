...
export default function Nav() {
    ...
    return (
        <nav className=" sticky xl:fixed bottom-0 flex   flex-col w-full top-0 z-50 xl:justify-center items-center gap-y-4 mt-auto xl:w-16 xl:max-w-md xl:h-screen xl:right-[2%]">
